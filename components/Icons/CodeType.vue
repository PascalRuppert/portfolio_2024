...
<template>
  ...
  >
    <path
      fill="currentColor"
      d="M1.001 3h4l7 12l7-12h4l-11 19l-11-19Zm8.667 0L12 7l2.333-4h4.035L12 14L5.633 3h4.035Z"
    />
  </svg>
  ...
  >
    <path
      fill="currentColor"
      d="m12 18.178l4.62-1.256l.623-6.778H9.026L8.822 7.89h8.626l.227-2.211H6.325l.636 6.678h7.82l-.261 2.866l-2.52.667l-2.52-.667l-.158-1.844h-2.27l.329 3.544L12 18.178ZM3 2h18l-1.623 18L12 22l-7.377-2L3 2Z"
    />
  </svg>

  <svg
    v-else-if="language === 'css'"
    class="w-full h-full"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
  >
